...
/*     */ 
/*     */ public class LobbyCaseCommand extends Command {
/*     */   public LobbyCaseCommand(String name) {
/*  16 */     super(name);
/*     */   }
/*     */   
...
/*  61 */     player.sendMessage("§e§lHeroWars §7§l| §7Benutze §e/lobbykiste add/remove/set/get <Spieler> <Anzahl> Normal/Plus§7.");
/*     */   }
/*     */   
...
/*  74 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("UPDATE `lobbycases` SET `amount` = ? WHERE `uuid` = ?");
...
/*     */       } else {
/*  80 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("INSERT INTO `lobbycases`(`uuid`, `name`, `amount`) VALUES (?,?,?)");
...
/*  91 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("UPDATE `lobbypluscases` SET `amount` = ? WHERE `uuid` = ?");
...
/*     */       } else {
/*  97 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("INSERT INTO `lobbypluscases`(`uuid`, `name`, `amount`) VALUES (?,?,?)");
...
/* 119 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("UPDATE `lobbycases` SET `amount` = ? WHERE `uuid` = ?");
...
/*     */       } else {
/* 125 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("INSERT INTO `lobbycases`(`uuid`, `name`, `amount`) VALUES (?,?,?)");
...
/* 136 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("UPDATE `lobbypluscases` SET `amount` = ? WHERE `uuid` = ?");
...
/*     */       } else {
/* 142 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("INSERT INTO `lobbypluscases`(`uuid`, `name`, `amount`) VALUES (?,?,?)");
...
/* 171 */       return 0; 
/* 172 */     PreparedStatement preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("SELECT `amount` FROM `lobbycases` WHERE `uuid` = ?");
...
/* 184 */       return 0; 
/* 185 */     PreparedStatement preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("SELECT `amount` FROM `lobbypluscases` WHERE `uuid` = ?");
...
/* 205 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("UPDATE `lobbycases` SET `amount` = ? WHERE `uuid` = ?");
/* 208 */         preparedStatement.setDouble(1, amount);
/* 209 */         preparedStatement.setString(2, player.getUniqueId().toString());
/*     */       } else {
/* 211 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("INSERT INTO `lobbycases`(`uuid`, `name`, `amount`) VALUES (?,?,?)");
...
/* 222 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("UPDATE `lobbypluscases` SET `amount` = ? WHERE `uuid` = ?");
/* 225 */         preparedStatement.setDouble(1, amount);
/* 226 */         preparedStatement.setString(2, player.getUniqueId().toString());
/*     */       } else {
/* 228 */         preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("INSERT INTO `lobbypluscases`(`uuid`, `name`, `amount`) VALUES (?,?,?)");
...
/* 241 */     PreparedStatement preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("SELECT `uuid` FROM `lobbycases` WHERE `uuid` = ?");
...
/* 252 */     PreparedStatement preparedStatement = (BanSystem.getInstance()).shopMySql.getConnection().prepareStatement("SELECT `uuid` FROM `lobbypluscases` WHERE `uuid` = ?");
